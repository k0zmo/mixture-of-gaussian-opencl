...
public:
   ...
   SapBufferWithTrash(int count, int *physAddress, int width = SapDefWidth, int height = SapDefHeight, SapFormat format = SapDefFormat, Type type = TypeContiguous);
   SapBufferWithTrash(int count, void **userAddress, int width = SapDefWidth, int height = SapDefHeight, SapFormat format = SapDefFormat, Type type = TypeScatterGather);
