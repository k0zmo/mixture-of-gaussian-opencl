...
public:
   ...
   virtual BOOL GetCapability(int cap, void *pValue) { return FALSE; }
   virtual BOOL GetParameter(int param, void *pValue) { return FALSE; }
   virtual BOOL SetParameter(int param, int value) { return FALSE; }
   virtual BOOL SetParameter(int param, void *pValue) { return FALSE; }
