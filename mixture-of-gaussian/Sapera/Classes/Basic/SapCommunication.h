...
const int SAPCOMM_TIMEOUT             = 5000;
...
public:
	...
	int      GetCommBufPhysAddr()		 const { return m_commBufPhysAddr;}
	...
	void SetCommBuf( void *commBufPtr, int commBufSize, int commBufPhysAddr)             
	{ 
