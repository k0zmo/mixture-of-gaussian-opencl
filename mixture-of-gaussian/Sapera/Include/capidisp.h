...
#define  CORDISPLAY_PRM_ADDRESS					      CORDISPLAY_PRM(16, 4)
#define  CORDISPLAY_PRM_PHYS_ADDRESS					CORDISPLAY_PRM(17, 4)
/*------------------------------------------------------------------------*/
...
CORSTATUS CORAPIFUNC CorDisplayGetDC( CORDISPLAY hDisplay, void *pDC);
