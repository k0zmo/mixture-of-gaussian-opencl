...
#define CORBUFFER_PRM_ADDRESS			 CORBUFFER_PRM( 8, 4)
#define CORBUFFER_PRM_PHYSADDRESS	 CORBUFFER_PRM( 9, 4)
...
#define CORBUFFER_PRM_INBWIN_ADDRESS CORBUFFER_PRM( 20, 4)
#define CORBUFFER_PRM_NSEG_USED      CORBUFFER_PRM( 21, 4)
#define CORBUFFER_PRM_SG_LIST        CORBUFFER_PRM( 22, 4)
#define CORBUFFER_PRM_SG_LIST_PHYSADDRESS   CORBUFFER_PRM( 23, 4)
...
CORSTATUS CORAPIFUNC CorBufferNewEx( CORSERVER server, UINT32 memWidth, UINT32 memHeight, UINT32 format, UINT32 type, UINT32 physAddress, UINT32 linearAddress, CORBUFFER *buffer);
CORSTATUS CORAPIFUNC CorBufferNew1DEx( CORSERVER server, UINT32 memWidth, UINT32 format, UINT32 type, UINT32 physAddress, UINT32 linearAddress, CORBUFFER *buffer);
CORSTATUS CORAPIFUNC CorBufferNew2DEx( CORSERVER server, UINT32 memWidth, UINT32 memHeight, UINT32 format, UINT32 type, UINT32 physAddress, UINT32 linearAddress, CORBUFFER *buffer);
...
/* Read/Write buffer */
CORSTATUS CORAPIFUNC CorBufferRead ( CORBUFFER buffer, UINT32 offset, void *array, UINT32 size);
CORSTATUS CORAPIFUNC CorBufferWrite( CORBUFFER buffer, UINT32 offset, const void *array, UINT32 size);
...
CORSTATUS CORAPIFUNC CorBufferMapEx( CORBUFFER buffer, UINT64 offset, UINT32 size);
CORSTATUS CORAPIFUNC CorBufferMapExEx( CORBUFFER buffer, UINT64 offset, UINT32 size, void* virtualAddress);
