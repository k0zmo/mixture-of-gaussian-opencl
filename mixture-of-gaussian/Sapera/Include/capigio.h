...
#define CORGIO_CAP_OUTPUT_TYPE               CORGIO_PRM(0x08, 4)
#define CORGIO_CAP_INPUT_LEVEL					CORGIO_PRM(0x09, 4)

#define CORGIO_CAP_LAST          (CORGIO_CAP_FIRST + 0x0A)
...
#define CORGIO_PRM_LAST          (CORGIO_PRM_FIRST + 0x0B)
...
#define CORGIO_VAL_EVENT_MASK                0x00000003
